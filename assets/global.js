    ...
    const handleIntersection = (entries, observer) => {
      ...
      if (this.innerHTML.trim() === '') {
        ...
        fetch(`${productUrl}?section_id=bulk-quick-order-list`)
          ...
          .catch((e) => {
            // Silently handle bulk modal loading error
          });
      }
    };
...
class ProductRecommendations extends HTMLElement {
  ...
  loadRecommendations(productId) {
    fetch(`${this.dataset.url}&product_id=${productId}&section_id=${this.dataset.sectionId}`)
      ...
      .catch((e) => {
        // Silently handle product recommendations loading error
      });
  }
}
...
const headerMenu = document.querySelector('#HeaderMenu-shop');
const headerMiddle = document.querySelector('.header--middle-center');
