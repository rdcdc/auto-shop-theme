  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      ...
      handleFormError(message) {
        const existingError = document.querySelector('.product-form-error');
        if (existingError) {
        ...
        // Add error message below the form
      ...
      onSubmitHandler(evt) {
        ...
        fetch(`${routes.cart_add_url}`, config)
          ...
          .catch((e) => {
            this.handleFormError('Unable to add item to cart. Please try again.');
          })
          .finally(() => {
